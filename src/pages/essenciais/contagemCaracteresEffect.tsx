...
export default function () {
  ...
  return (
    <Pagina titulo="Contagem de caracteres" subtitulo="Entendendo as funções de limpezas">
      ...
      <textarea
        ...
        className={`border border-zinc-700 bg-zinc-700 text-white text-2xl w-3/5 h-72 rounded-lg p-5`}
      ></textarea>
    </Pagina>
  )
}